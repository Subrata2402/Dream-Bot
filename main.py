...
async def q(ctx,que: str):
             await ctx.delete()
	     embed=discord.Embed(title="**__QUESTION ALERT !__**", url="https://discord.gg/2degbQMAxU", description=f"**Question No. {que} is coming soon on your mobile screen.**", color=discord.Color.red())
